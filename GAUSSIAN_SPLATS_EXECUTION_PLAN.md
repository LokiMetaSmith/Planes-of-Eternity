...
3.  [x] **Update WGSL Shader for Splatting**
...
4.  [x] **Modify WGPU Render Pipeline**
...
5.  [x] **Implement CPU-side Sorting**
...
7.  [x] **Integrate Cellular Automata**
