...
- [x] **Task 4.1:** Pass final discrete latent tokens through VqVae::decode_from_indices.
- [x] **Task 4.2:** Map the VQ-VAE output channels to physical Gaussian Splat properties (position, scale, rotation, color/opacity) into the SplatVertex format.
