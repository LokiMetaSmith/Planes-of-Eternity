...
fn generate_splats_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("generate_splats_full_chunk", |b| b.iter(|| {
    ...
    c.bench_function("generate_splats_sparse_chunk", |b| b.iter(|| {
    ...
    c.bench_function("generate_mesh_full_chunk", |b| b.iter(|| {
    ...
    c.bench_function("generate_mesh_sparse_chunk", |b| b.iter(|| {
